...
print 'Install hiseq-analysis-tools Started......'
argvs = sys.argv
argc = len(argvs)
...
def main():
    try:
        ...
        os.chdir(tooldir)
        git_url = 'https://github.com/myoshimura080822/galaxy_preparation_of_analysis.git'
        Repo.clone_from(git_url, 'galaxy_preparation_of_analysis')

        print ':::::::::::::::::::::::::::::::::::::::::::'
        print '>>>>>>>>>>>>>>>>> add tool-node to tool_conf.xml...'
        mytoolsdir = tooldir + '/galaxy_preparation_of_analysis/'
