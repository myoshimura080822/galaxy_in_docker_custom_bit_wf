...
print u"Import DataLibraries Started......"
...
def create_pair_path(root_dir):
    ...
    print keys_list
    lane_01 = list(path_list[keys_list[0]][0])
    lane_01.sort()
    print len(lane_01)
    lane_02 = list(path_list[keys_list[1]][0])
    lane_02.sort()
    print len(lane_02)
...
def merge_pair_fastq(list, outdir):
    ...
    for i, item in enumerate(list):
        output_filename = outdir + str(os.path.basename(item[0])).replace("_L001","").replace(".gz","")
